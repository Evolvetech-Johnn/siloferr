...
export const metadata = {
  ...
  description: "Confira nossa linha completa de equipamentos agrícolas, silos e acessórios industriais de alta performance.",
};
      ...
      <main className="min-h-screen pt-24 pb-20 bg-bg-main">
        ...
        <div className="bg-primary-dark text-white py-16 mb-12 relative overflow-hidden">
          ...
          <div className="container-custom relative z-10">
            <h1 className="text-4xl md:text-5xl font-heading font-bold mb-4">Catálogo de Produtos</h1>
            <p className="text-xl text-white/80 max-w-2xl">
              Soluções robustas e inovadoras para armazenagem e processamento de grãos.
            </p>
          </div>
        </div>
