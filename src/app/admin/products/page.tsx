      ...
      <div className="flex justify-between items-center bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
        <div>
          ...
          <p className="text-text-muted mt-1 text-lg">
            Catálogo B2B para vitrine pública do site.
          </p>
        </div>
        <Link
          href="/admin/products/new"
          className="btn-primary px-8 shadow-lg shadow-primary/20"
        >
          <Plus size={20} />
            ...
            <tbody className="divide-y divide-gray-50">
              {products.length === 0 ? (
                  ...
                  <td colSpan={5} className="p-20 text-center">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <p className="text-text-muted max-w-sm">
                        Comece a povoar sua vitrine adicionando seu primeiro
                ...
                products.map((product) => (
                  <tr
                    key={product.id}
                    className="hover:bg-blue-50/20 transition-all duration-300"
                  >
                    <td className="p-6">
