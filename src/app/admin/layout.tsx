    ...
    <div className="min-h-screen bg-bg-alt flex">
      ...
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col hidden md:flex">
        <div className="p-6 border-b border-gray-100 flex justify-center">
          ...
          <img src="/Content/img/logo.png" alt="Siloferr" className="h-8 w-auto" />
        </div>
        <nav className="flex-1 p-4 flex flex-col gap-2">
          <Link href="/admin" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-bg-alt text-text-main font-medium transition-colors">
            <LayoutDashboard size={20} className="text-primary" />
            Visão Geral
          </Link>
          <Link href="/admin/leads" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-bg-alt text-text-main font-medium transition-colors">
            <Users size={20} className="text-primary" />
            Cotações/Leads
          </Link>
          <Link href="/admin/products" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-bg-alt text-text-main font-medium transition-colors">
