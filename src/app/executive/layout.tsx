    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <aside className="w-64 bg-slate-900 text-slate-300 border-r border-slate-800 flex flex-col hidden md:flex">
        <div className="p-6 border-b border-slate-800 flex justify-center">
          ...
          <img src="/Content/img/logo.png" alt="Siloferr" className="h-8 w-auto brightness-0 invert" />
        </div>
        <nav className="flex-1 p-4 flex flex-col gap-2">
          <Link href="/executive" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-800 text-white font-medium transition-colors">
            <BarChart3 size={20} className="text-accent" />
            Visão Executiva
          </Link>
          <Link href="/executive/reports" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-slate-800 text-white font-medium transition-colors">
            <TrendingUp size={20} className="text-accent" />
            Relatórios e Metas
          </Link>
        </nav>
        <div className="p-4 border-t border-slate-800">
          <Link href="/api/auth/signout" className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-red-500/10 text-red-400 font-medium transition-colors">
            <LogOut size={20} />
            Sair
          </Link>
        </div>
